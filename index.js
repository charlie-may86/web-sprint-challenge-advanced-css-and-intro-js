...
// console.log(typeof(artists[0]['years']))
// let x = '1920 - 1930'
// console.log(x.length)
// console.log(x.substr(0,2))
// console.log(x.substr(7,2))
// if(x.substr(0,2) === '19' && x.substr(7,2) === '19') {
//   console.log('They lived and died in the 19th century')
// }
function get20s(arr){
  let newArr = [];
  for (let i = 0; i < arr.length; i++) {
    if (arr[i]['years'].substr(0,2) === '19' && arr[i]['years'].substr(7,2) === '19') {
...
console.log(typeof(artists[0]['paintings']))
